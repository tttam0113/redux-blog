...
import { FEATURE, CLEAR_POSTS, FETCH_POSTS, setPosts, clearPosts } from 'redux/actions/posts';
// import { apiRequest, API_SUCCESS } from '../../actions/api';
import { firebaseApiRequest, FIREBASE_API_SUCCESS } from 'redux/actions/firebaseApi';
import { setPostsLoading } from 'redux/actions/ui';
